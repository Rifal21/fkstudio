                ...
                <div class="row align-items-lg-end align-items-center small-screen md-h-auto text-sm-start text-center">
                    <div class="col-12 position-relative page-title-extra-large md-mb-70px sm-mb-50px xs-mb-20px"> 
                        <div class="fw-800 text-black fs-160 md-fs-130 sm-fs-110 xs-fs-70 ls-minus-4px md-ls-minus-2px text-uppercase">
                            <div data-bottom-top="transform: translate3d(-50px, 0px, 0px);" data-top-bottom="transform: translate3d(50px, 0px, 0px);">{{ $servicehero['title'] }}</div> 
                            <div class="ms-10 xs-ms-0" data-bottom-top="transform: translate3d(50px, 0px, 0px);" data-top-bottom="transform: translate3d(-50px, 0px, 0px);">{{ $servicehero['subtitle'] }}</div> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-end text-center text-sm-start" data-anime='{ "el": "childs", "translateX": [-15, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-xl-4 col-lg-5 offset-xl-1 md-mb-15px">
                        <div class="fs-19 fw-600 text-black">{{ $servicehero['desc_one'] }}</div>
                        <span class="w-70 xl-w-100 sm-w-70 xs-w-80 d-block xs-mx-auto">{{ $servicehero['desc_two']}}</span>
                    </div>
                    <div class="col-lg-7">
                        <div class="fs-80 sm-fs-50 text-black fw-200">- <span class="fs-130 lg-fs-110 xs-fs-75 ls-minus-4px md-ls-minus-2px font-style-italic alt-font fw-500">{{ $servicehero['branding'] }}</span></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="position-relative overflow-hidden">
            <div class="skrollr-parallax magic-cursor round-cursor mx-auto" data-bottom-top="width: 54%" data-center-top="width: 86%;" data-parallax-background-ratio="0.5" style="background-image: url('{{cockpitImage($servicehero['image']) ?? 'https://fakeimg.movexa.id/1920x1200/eeeeee/cccccc'}}')">
                <div class="container">
